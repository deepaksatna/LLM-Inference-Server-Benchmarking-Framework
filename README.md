...
|----------|--------|-------|
| **Peak Throughput** | TGI | 8.07 req/s |
| **Token Generation** | vLLM | 412 tok/s |
| **Lowest Latency** | TGI | 1704ms P95 |
...
|-----|------|-------------------|---------------------|
| **A10** | 24GB | `max-model-len: 4096` | 400-450 tok/s |
| **A100 40GB** | 40GB | `max-model-len: 8192` | 800-1000 tok/s |
| **A100 80GB** | 80GB | `max-model-len: 16384` | 900-1200 tok/s |
| **H100** | 80GB | `max-model-len: 32768` | 1500-2000 tok/s |
| **H200** | 141GB | `max-model-len: 65536` | 2000-2500 tok/s |
| **B200** | 192GB | `max-model-len: 131072` | 3000+ tok/s |
...
| CUDA Kernel Timeline | Deep profiling | **NVIDIA Nsight Systems** |
| Memory Allocations | Deep profiling | **NVIDIA Nsight Systems** |
| cuBLAS/cuDNN Calls | Deep profiling | **NVIDIA Nsight Systems** |
...
|--------|---------------|----------|
| vLLM | 15-25 MB | Full CUDA kernels during inference |
| Triton | 5-15 MB | Model loading + inference |
| TGI | 10-20 MB | Flash Attention kernels |
